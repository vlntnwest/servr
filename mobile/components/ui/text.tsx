  ...
  ),
  {
    variants: {
      variant: {
        default: '',
        display: cn(
          'font-display text-5xl tracking-tighter leading-none',
        ...
        cardLabel: 'font-display text-2xl italic tracking-tight',
        ...
        caption: 'font-sans-medium text-xs uppercase tracking-widest',
